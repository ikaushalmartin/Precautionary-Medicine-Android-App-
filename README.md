<h2>Premed(Precautionary Medicine) Android Application</h2>
...
Try to use credential as Username - admin and Password - 1234 If you have not connected with database
